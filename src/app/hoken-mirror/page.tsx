...
export default function HokenMirror() {
  ...
  const recommendation = getRecommendations('lifeplan')[0];
    ...
    <main className="container min-h-screen">
      ...
      {recommendation && (
        <div style={{ marginTop: '3rem', maxWidth: '700px', margin: '3rem auto 0' }}>
          <h3 style={{ fontSize: '1rem', fontWeight: 'bold', marginBottom: '1.2rem', color: '#94a3b8', textAlign: 'center' }}>
            📈 資産形成のヒントになる一冊
          </h3>
          <AffiliateCard item={recommendation} label="ライフプランに役立つ" />
        </div>
      )}

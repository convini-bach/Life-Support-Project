...
export const dictionary: Dictionary = {
  ja: {
    ...
    'analysis.error.safety_limit': '本日の上限（50回）に達しました。不正利用防止のため、明日のAM0:00までリセットをお待ちください。',
    ...
    'profile.status.title': 'ユーザー情報',
    'profile.status.premium': '',
    'profile.status.free': '',
    'profile.button.upgrade': '',
    'profile.button.manage_subscription': '',
    ...
    'profile.premium_benefit': 'ログインすることで、データの保護や将来的な同期が可能になります。',
    'profile.login': 'ログイン',
    'profile.signup': '新規登録',
    'profile.height': '身長',
  ...
  en: {
    ...
    'nav.terms': 'Terms',
    'nav.privacy': 'Privacy',
    'nav.scta': 'Legal Information',
    'nav.pricing': 'Monetization',
    ...
    'analysis.error.safety_limit': 'Daily limit (50 requests) reached. Please wait until 0:00 AM for the reset.',
    ...
    'profile.premium_benefit': 'Logging in enables data protection and future synchronization.',
    'profile.login': 'Login',
